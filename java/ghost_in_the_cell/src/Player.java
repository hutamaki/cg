        ...
        while (true) {
            ...
            for (int i = 0; i < entityCount; i++) {
                ...
                if (entityType.equals("FACTORY")) {
                	int arg1 = in.nextInt(); // joueur qui poss�de l'usine : 1 pour vous, -1 pour l'adversaire et 0 si neutre 
                    ...
                    int arg1 = in.nextInt(); // joueur qui poss�de la troupe : 1 pour vous, -1 pour l'adversaire
                    ...
                    int arg5 = in.nextInt(); // nombre de tours avant d'arriver � destination (entier strictement positif)
                }
            }
